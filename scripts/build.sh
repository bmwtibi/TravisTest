...
xcodebuild archive -workspace TravisTest.xcworkspace -scheme TravisTest -configuration Release -derivedDataPath ./build -archivePath ./build/Products/travistest.xcarchive
...
xcodebuild -exportArchive -archivePath ./build/Products/travistest.xcarchive -exportOptionsPlist ./scripts/certs/AdhocExportOptions.plist -exportPath ./build/Products/IPA

#mv Ipas/Dev/TravisTest.ipa ./TravisTest-Dev.ipa
mv ./build/Products/IPA ./TravisTest-Adhoc.ipa